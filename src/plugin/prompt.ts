export const SYSTEM_PROMPT_LINES = [
  ...
  '- 写成概念页 / 更新编译页 / 记进目录 → wenmai_write（禁止写 raw/；补 frontmatter、wikilinks、index、log；补写缺页时可带 finding）',
  ...
  '- 目录点了但没写 / 查库里有没有旧稿可编译 → wenmai_research（默认关；关掉时说明打开 research: true，禁止改去抓网页；只出简报，不写盘）',
